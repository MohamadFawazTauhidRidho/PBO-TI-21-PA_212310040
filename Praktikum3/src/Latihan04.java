...
public class Latihan04 {
	...
	public static void main(String[] args) {
		...
		while(isLanjut) {
			...
			bio.setFullname(nama);
			bio.setAlamat(alamat);
			bio.setAge(Age);
			
			String outputNama = bio.getFullname();
			String outputAlamat = bio.getAlamat();
			int outputAge = bio.getAge();
			JOptionPane.showMessageDialog(null, outputNama);
			JOptionPane.showMessageDialog(null, outputAlamat);
			JOptionPane.showMessageDialog(null, outputAge);
